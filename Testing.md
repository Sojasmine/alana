...
![error](screenshot/settings.png)


> The reason I did not fix this error is because those codes are not written by me. Those code were autogenerated by djngo itself. I am afriad making a change under the passwords validator will broke the app and it’s functionality.  Preferred to undo and ignore those line errors. 
...
* Checkout: 
   ...
   * models.py: 
   ...
   ![error](screenshot/models.png)


   * views: py:

   ![error](screenshot/views.png)


   * webhook.handler.py:

   ![error](screenshot/webhook.png)


> I choose not to do anything about those errors because I am afraid fixing those problems will affect the functionality of my website

* Product: 
   
   * views.py:

![error](screenshot/product.png)

> I choose not to anything about this error. I have tried some soutions without better result. 
